...
export const HEDERA_RPC_URL = process.env.NEXT_PUBLIC_HEDERA_RPC_URL ?? "https://testnet.hashio.io/api"
...
export const MINIMUM_STAKE = BigInt(process.env.NEXT_PUBLIC_MINIMUM_STAKE ?? "10000000000000000") // 0.01 HBAR in wei
